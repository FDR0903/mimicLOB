...
def addSentOrders():
    ...
    if agentData.verbose:
        print(f'\n************ received a sent order notification : ************\n {str(order)}')
...
def notify_order_modification():
    ...
    if agentData.verbose:
        print(f'\n************ received a modification notification : ************\n {str(order_update)}')
...
def notify_order_cancelation():
    ...
    if agentData.verbose:
        print(f'\n************ received a cancelation notification : ************\n {side} : {order_id}')
...
def notify_orders_in_book():
    ...
    if agentData.verbose:
        print(f'\n************ received an order in book notification : ************\n {str(pendingOrder)}')
